            ...
            <li class="nav-item">
                ...
                <div id="collapseTables" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="product.php?name=product">Danh sách sản phẩm</a>
                        <a class="collapse-item" href="tacgia.php?name=tacgia">Danh sách tác giả</a>
                        <a class="collapse-item" href="nxb.php?name=nxb">Danh sách Nhà xuất bản</a>
                        <a class="collapse-item" href="category.php?name=category">Danh sách danh mục</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Đơn hàng:</h6>
                        <a class="collapse-item" href="orders.php?name=order">Danh sách đơn hàng</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseTables1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="image.php?name=image">Hình ảnh</a>
                        <a class="collapse-item" href="news.php?name=news">Tin tức</a>
                    </div>
                </div>
            </li>
